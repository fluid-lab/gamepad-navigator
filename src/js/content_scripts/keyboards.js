...
(function (fluid) {
    ...
    fluid.defaults("gamepad.osk.keyboard.text", {
        ...
        rowDefs: [
            ...
            [osk.keydefsByCode.KeyA, osk.keydefsByCode.KeyS, osk.keydefsByCode.KeyD, osk.keydefsByCode.KeyF, osk.keydefsByCode.KeyG, osk.keydefsByCode.KeyH, osk.keydefsByCode.KeyJ, osk.keydefsByCode.KeyK,  osk.keydefsByCode.KeyL, osk.keydefsByCode.Semicolon, osk.keydefsByCode.Quote],
    ...
    fluid.defaults("gamepad.osk.keyboard.numpad", {
        ...
        rowDefs: [
            ...
            [osk.keydefsByCode.Comma, gamepad.osk.keyboard.numpad.keydefs.Digit0, osk.keydefsByCode.Period ],
            [osk.keydefsByCode.ArrowLeft, osk.keydefsByCode.ArrowRight, osk.keydefsByCode.Backspace ]
        ]
    });
